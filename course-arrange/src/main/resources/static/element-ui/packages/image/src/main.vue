...
<script>
  ...
  import { on, off, getScrollContainer, isInContainer } from 'static/element-ui/src/utils/dom';
  import { isString, isHtmlElement } from 'static/element-ui/src/utils/types';
