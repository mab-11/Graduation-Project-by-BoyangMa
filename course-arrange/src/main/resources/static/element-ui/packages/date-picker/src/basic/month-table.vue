...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'static/element-ui/src/utils/date-util';
  import { hasClass } from 'static/element-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'static/element-ui/src/utils/util';
